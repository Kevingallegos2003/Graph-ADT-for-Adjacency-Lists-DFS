...
bool equals(List A, List B); // Returns true iff Lists A and B are in same otherwise it returns false
...
void delete(List L); // Delete cursor element, making cu
